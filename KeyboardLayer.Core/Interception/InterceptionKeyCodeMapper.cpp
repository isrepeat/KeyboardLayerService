...
namespace Interception {
	std::optional<int> InterceptionKeyCodeMapper::ToNative(Keyboard::Core::Enums::LogicalKey key) const {
		using LK = Keyboard::Core::Enums::LogicalKey;
		using IK = Enums::InterceptionKeyCode;
...
#undef MAP
	...
	std::optional<Keyboard::Core::Enums::LogicalKey> InterceptionKeyCodeMapper::FromNative(int code) const {
		using LK = Keyboard::Core::Enums::LogicalKey;
		using IK = Enums::InterceptionKeyCode;
